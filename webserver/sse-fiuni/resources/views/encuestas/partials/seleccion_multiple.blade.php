<div id="seleccion_multiple" class="tipo_pregunta col-9 m-auto d-none">
    <form method="POST" action="{{ '/encuestas/add_pregunta' }}" class="needs-validation" novalidate>
        <div class="row">
            <div class="float-left col-9"><h2>Seleccion Multiple</h2></div>
        ...
        <input type="hidden" name="tipo_pregunta" value="seleccion_multiple">
        <div class="mb-4">
    ...
    <div class="mb-3">
        <div class="col-8">
            ...
            <div class="col-auto">
                <input class="form-control" id="autoSizingInput" type="text" name="sm_opcion_agg" placeholder="Opcion" />
            </div>
            <div class="col-auto">
                <button id="sm_add_btn" class="btn btn-primary" type="button">Agregar</button>
            </div>
            </div>
            <div class="table-responsive scrollbar">
            <table class="table">
                <tbody id="sm_options_table">
                </tbody>
            </table>
            </div>
        </div>
