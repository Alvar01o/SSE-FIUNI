<li class="nav-item">
    ...
    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
        <div class="col-auto navbar-vertical-label">Administrar Usuarios
        </div>
        <div class="col ps-0">
...
<!-- label-->
    <div class="row navbar-vertical-label-wrapper mt-3 mb-2">
        <div class="col-auto navbar-vertical-label">Administrar Egresados
        </div>
        <div class="col ps-0">
            <hr class="mb-0 navbar-vertical-divider" />
        </div>
    </div>
    <a class="nav-link dropdown-indicator" href="#" role="button" data-bs-toggle="collapse" aria-expanded="false">
        <div class="d-flex align-items-center"><span class="nav-link-icon"><span class="fas fa-user-graduate"></span></span><span class="nav-link-text ps-1">Egresados</span>
        </div>
    </a>
    <ul class="nav collapse show" id="icons" style="">
        <li class="nav-item"><a class="nav-link" href="/egresado/lista" data-bs-toggle="" aria-expanded="false">
            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Administrar Egresados</span>
            </div>
            </a>
            <!-- more inner pages-->
        </li>
        <li class="nav-item"><a class="nav-link" href="/carreras" data-bs-toggle="" aria-expanded="false">
            <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Carreras</span>
            </div>
            </a>
        </li>
    </ul>
    <a class="nav-link" href="/encuestas" role="button" data-bs-toggle="" aria-expanded="false">
